...
class ReceiptController extends Controller
{
...

    {
        ...
        if ($type === 'list') {
            ...
            $creditors = Contact::query()->where('is_creditor', 1)->orderBy('name')->paginate(25)->select('id', 'name');
            ...
            return response()->json(['grouped' => collect($groupedReceipts)->sortBy('sort', SORT_NATURAL)->values()->all()]);
        }
    }
